## Introduction_Training_ImageProcessing1
Start processing the periodically provided data
...
The purpose of this one is to begin with the processing of the periodically
provided data by simply displaying the images on the web GUI of your SensorApp.

### Topics
training, introduction, gui, viewer, image, processing, sampleapp, sick-appspace
